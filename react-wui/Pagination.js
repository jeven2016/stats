        ...
        return (
            <div className="pagination">
                <div className="button-group clear-border">
                    <button className="button" onClick={goTo.bind(this, 1)}>|&lt;</button>
                    <button className="button" onClick={goPrevious.bind(this)}>&lt;</button>
                    {buttons}
                    <button className="button" onClick={goNext.bind(this)}>&gt;</button>
                    <button className="button" onClick={goTo.bind(this, totalPages)}>&gt;|</button>
                </div>
            </div>
        )
    }
